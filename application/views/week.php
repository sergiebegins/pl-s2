						...
						<div class="card-body">
							...
							<table id="example" class="display" cellspacing="0" width="100%">
								...
								<?php foreach ($list as $k=>$v){ ?>
									<tr>
										<td><?=$v?></td>
										<td><?php $puan[$k] = ($score['result']['week'][0][$k]*3)+($score['result']['week'][2][$k]);echo $puan[$k];?></td>
										<td><?=$week?></td>
										<td><?=$score['result']['week'][0][$k]?></td>
										<td><?=$score['result']['week'][2][$k]?></td>
										<td><?=$score['result']['week'][1][$k]?></td>
										<td><?=$score['result']['avg'][$k]?></td>
					...
					<div class="card" >
						<div class="card-body">
							...
							<table id="example2" class="display" cellspacing="0" width="100%">
								<tbody>
								<?php $c=0; foreach ($fixture[$week] as  $k=>$v){  ?>
									<tr>
										<td><?=$list[$k]?></td>
										<td><?=$score['result']['score'][$c][0]?> - <?=$score['result']['score'][$c][1]?> </td>
										<td><?=$list[$v]?></td>
									</tr>
								<?php $c++; } ?>
								</tbody>
